...
public class EcoEnchants {
    ...
    public static final EcoEnchant TRANSDIMENSIONAL = new Transdimensional();
    public static final EcoEnchant REVERSAL_CURSE = new ReversalCurse();
    public static final EcoEnchant TENSIONED = new Tensioned();
