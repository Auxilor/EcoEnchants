...
public class Transdimensional extends EcoEnchant {
    public Transdimensional() {
        super(
                "transdimensional", EnchantmentType.NORMAL
        );
    }
    ...
    public void onBlockBreak(@NotNull final Player player,
        ...
        if (!block.getType().equals(Material.STONE) && !block.getType().equals(Material.NETHERRACK) && !block.getType().equals(Material.END_STONE)) {
            return;
        }
